...
bool check4(int question_list[10], int r){
    bool repeat= false;
    for(int i = 0; i<10; i++){
...
void arts::Read(QString list) {
     QFile file ("C:/Users/Delano/Documents/Project/Arts and Literature.txt"); //You need to change the locatating to where your questions are located
...
void arts::on_pushButton_clicked()
{
...
void arts::on_pushButton_2_clicked()
{
    QString list;
...
void arts::on_pushButton_3_clicked()
{
    QString list;
...
void arts::on_pushButton_4_clicked()
{
    QString list;
    QString answer = "answer4";
    list="0";
...
void arts::on_pushButton_5_clicked()
{
    QString list;
    QString answer = "answer2";
    list="17";
...
void arts::on_pushButton_6_clicked()
{
    QString list;
...
void arts::on_pushButton_7_clicked()
{
    QString list;
    QString answer = "answer1";
    list="5";
...
void arts::on_pushButton_8_clicked()
{
    QString list;
    QString answer = "answer3";
    list="16";
...
void arts::on_pushButton_9_clicked()
{
    QString list;
    QString answer = "answer2";
    list="9";
...
void arts::on_pushButton_10_clicked()
{
    QString list;
    QString answer = "answer2";
    list="13";
...
void arts::on_answer1_clicked(QString answer)
{
    if (answer=="answer1"){
        QMessageBox msgBox;
...
void arts::on_answer2_clicked(QString answer)
{
    if (answer=="answer2"){
        QMessageBox msgBox;
        msgBox.setText("This is a right");
...
void arts::on_answer3_clicked(QString answer)
{
    if (answer=="answer3"){
...
void arts::on_answer4_clicked(QString answer)
{
    if (answer=="answer4"){
