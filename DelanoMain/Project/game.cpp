...
void Game::Read(QString list) {
     QFile file ("C:/Users/Delano/Documents/Project/History.txt"); //You need to change the locatating to where your questions are located
...
void Game::on_answer1_clicked(QString answer)
{
    if (answer=="answer1"){
        QMessageBox msgBox;
...
void Game::on_answer2_clicked(QString answer)
{
    if (answer=="answer2"){
        QMessageBox msgBox;
        msgBox.setText("This is a right");
...
void Game::on_answer3_clicked(QString answer)
{
    if (answer=="answer3"){
...
void Game::on_answer4_clicked(QString answer)
{
    if (answer=="answer4"){
