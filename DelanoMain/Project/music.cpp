...
bool check2(int question_list[10], int r){
    bool repeat= false;
    for(int i = 0; i<10; i++){
...
void music::Read(QString list) {
     QFile file ("C:/Users/Delano/Documents/Project/Music.txt"); //You need to change the locatating to where your questions are located
...
void music::on_pushButton_10_clicked()
{
    QString list;
    QString answer = "answer2";
    list="13";
...
void music::on_answer1_clicked(QString answer)
{
    if (answer=="answer1"){
        QMessageBox msgBox;
...
void music::on_answer2_clicked(QString answer)
{
    if (answer=="answer2"){
        QMessageBox msgBox;
        msgBox.setText("This is a right");
...
void music::on_answer3_clicked(QString answer)
{
    if (answer=="answer3"){
...
void music::on_answer4_clicked(QString answer)
{
    if (answer=="answer4"){
